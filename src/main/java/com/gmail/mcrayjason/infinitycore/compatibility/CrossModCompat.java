    ...
    private static void sendThaumcraftIMC()
        {
            ...
            // Antimony Clusters
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Stibnite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 20 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreNetherrack, Materials.Stibnite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 20 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreEndstone, Materials.Stibnite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 20 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreBlackgranite, Materials.Stibnite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 20 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreRedgranite, Materials.Stibnite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 20 + ",1.0");
            // Beryllium Clusters
            ...
            // Endium Clusters
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(BlockList.endium_ore) + "," + 0 + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 21 + ",1.0");
            // Iridium Clusters
            ...
            // Magnesium Clusters
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Magnesite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 18 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreNetherrack, Materials.Magnesite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 18 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreEndstone, Materials.Magnesite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 18 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreBlackgranite, Materials.Magnesite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 18 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreRedgranite, Materials.Magnesite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 18 + ",1.0");
            // Manganese Clusters
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Pyrolusite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 19 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreNetherrack, Materials.Pyrolusite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 19 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreEndstone, Materials.Pyrolusite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 19 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreBlackgranite, Materials.Pyrolusite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 19 + ",1.0");
            FMLInterModComms.sendMessage("Thaumcraft", "nativeCluster", Block.getIdFromBlock(GregTech_API.sBlockOres1) + "," + GT_OreDictUnificator.get(OrePrefixes.oreRedgranite, Materials.Pyrolusite, 1L).getItemDamage() + "," + Item.getIdFromItem(ModItems.itemCluster) + "," + 19 + ",1.0");
            // Molybdenum Clusters
